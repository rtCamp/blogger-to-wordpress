...
######################################################
######################## VARS ########################
SITE_NAME='blogger-to-wordpress.com'
...
function create_and_configure_site () {
    ...
    mkdir blogger-to-wordpress
    rsync -azh $GITHUB_WORKSPACE/ $SITE_ROOT/wp-content/plugins/blogger-to-wordpress
    echo "127.0.0.1 $SITE_NAME" >> /etc/hosts
    ls
    wp plugin activate blogger-to-wordpress --allow-root
