	...
	<table width="350px">
		...
		foreach ( $results as $index => $result ) {
			...
			<tr>
				...
				<td  width="75px"><input type="submit" class="button" onclick = "generate_code(<?php echo sprintf( '\'%1$s\',\'%2$s\',\'%3$s\',\'%4$s\'', esc_js( RT_B2WR_PLUGIN_URL ), esc_js( $result->meta_value ), esc_js( RT_B2WR_BLOG_URL ), esc_js( $nonce ) ); ?>);" name="start" value="<?php esc_attr_e( 'Get Code', 'blogger-to-wordpress' ); ?>"/></td>
			</tr>
